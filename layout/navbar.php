...
<ul class="header-content-right">
    <li class="header-element md:!hidden block">
        <a aria-label="anchor" href="javascript:void(0);" class="header-link" data-bs-toggle="modal"
            data-hs-overlay="#header-responsive-search"><i class="bi bi-search header-link-icon"></i>
        </a>
    </li>
    <li class="header-element header-theme-mode hidden !items-center sm:block md:!px-[0.5rem] px-2">
        <a aria-label="anchor"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 header-link-icon" fill="none" viewBox="0 0 24 24"
    ...
    <li class="header-element cart-dropdown hs-dropdown ti-dropdown [--auto-close:inside]">
        ...
        <div class="main-header-dropdown hs-dropdown-menu ti-dropdown-menu hidden" data-popper-placement="none"
                                ...
                                <div class="simplebar-content" style="padding: 0px;">
                                    <li class="ti-dropdown-item block">
                                        <div class="flex items-center cart-dropdown-item gap-4">
                                            <div class="leading-none"> <span class="avatar avatar-xl bg-primary/10">
                                                    <img src="./assets/images/ecommerce/png/30.png"
                                                        alt="Wireless Headphones"> </span> </div>
                                            <div class="flex-auto">
                                                <div class="flex items-center justify-between mb-0">
                                                    <div class="mb-0 text-[14px] font-medium">
                                                        ...
                                                        <div class="truncate">
                                                            <p
                                                                ...
                                                                Wireless freedom with crystal-clear sound and
                                                                comfortable </p>
                                                    ...
                                                    <div class="text-end">
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            aria-label="anchor"><i class="ri-close-line"></i></a>
            ...
            <div class="p-4 empty-header-item border-t grid items-center"> <a href="#"
                    class="ti-btn ti-btn-primary btn-wave text-center waves-effect waves-light">Proceed to checkout</a>
            </div>
            <div class="p-[3rem] empty-item hidden">
                <div class="text-center">
                    <span class="avatar avatar-xl avatar-rounded bg-primary/10 !text-primary"> <i
                            class="ri-shopping-cart-2-line fs-2"></i> </span>
                    <h6 class="font-medium mb-1 mt-3">Your Cart is Empty</h6>
                    <span class="mb-3 font-normal text-[13px] block">Add some items to make me happy :)</span> <a
                        href="#"
    ...
    <li class="header-element notifications-dropdown !hidden xl:!block hs-dropdown ti-dropdown [--auto-close:inside]">
        <a aria-label="anchor" href="javascript:void(0);" class="header-link hs-dropdown-toggle ti-dropdown-toggle"
            ...
            <span class="badge bg-secondary rounded-full header-icon-badge text-white" id="notification-icon-badge">
        ...
        <div class="main-header-dropdown hs-dropdown-menu ti-dropdown-menu hidden" data-popper-placement="none"
            ...
            <div class="p-4 empty-header-item1 border-t">
                <div class="grid"> <a href="javascript:void(0);"
                        class="ti-btn ti-btn-primary btn-wave waves-effect waves-light">View All</a> </div>
            </div>
            <div class="p-[3rem] empty-item1 hidden">
                <div class="text-center">
                    <span class="avatar avatar-xl avatar-rounded bg-secondary/10 !text-secondary"> <i
    ...
    <li class="header-element header-fullscreen">
        <a onclick="openFullscreen();" href="javascript:void(0);" class="header-link" aria-label="anchor">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 full-screen-open header-link-icon" fill="none"
    ...
    <li class="header-element ti-dropdown hs-dropdown">
        ...
        <ul class="main-header-dropdown hs-dropdown-menu ti-dropdown-menu pt-0 overflow-hidden header-profile-dropdown hidden"
            aria-labelledby="mainHeaderProfile" role="menu">
            <li>
                <div
            ...
            <li><a class="ti-dropdown-item flex items-center" href="#" id="logout-btn"><i
